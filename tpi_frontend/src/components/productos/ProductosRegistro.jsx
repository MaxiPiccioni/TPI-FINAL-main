...
export default function ProductosRegistro({ AccionABMC, Item, Grabar, Volver }) {
  const {
    register,
    handleSubmit,
          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                autoFocus
                className={"form-control " + (errors?.nombre_prod ? "is-invalid" : "")}
              />
              {errors?.nombre_prod && touchedFields.nombre_prod && (
                <div className="invalid-feedback">{errors?.nombre_prod?.message}</div>
              )}
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                className={"form-control " + (errors?.fecha_elaboracion ? "is-invalid" : "")}
              />
              <div className="invalid-feedback">{errors?.fecha_elaboracion?.message}</div>
            </div>
          </div>
            ...
            <div className="col-sm-8 col-md-6">
              <select
                {...register("id_proveedor", {
                  required: { value: true, message: "Nombre del Proveedor es requerido" },
                })}
              ...
              <div className="invalid-feedback">{errors?.id_proveedor?.message}</div>
            </div>
          </div>
